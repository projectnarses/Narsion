...
public class GamemodeCommand extends NarsionCommand<NarsionServer> {
    ...
    public GamemodeCommand(NarsionServer server) {
        ...
        //GameMode parameter
        ArgumentEnum<GameMode> gamemode = Enum("gamemode", GameMode.class).setFormat(ArgumentEnum.Format.LOWER_CASED);
        ...
        ArgumentEntity player = Entity("targets").onlyPlayers(true);
